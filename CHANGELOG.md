...
- GetAllCoinBalances (`sui_getAllBalances`) builder added [0.20.0](https://github.com/FrankC01/pysui/issues/55)
- GetAllCoins builder added [0.20.0](https://github.com/FrankC01/pysui/issues/55)
- GetDynamicFieldObject builder added [0.20.0](https://github.com/FrankC01/pysui/issues/55)
- GetDynamicFields builder added [0.20.0](https://github.com/FrankC01/pysui/issues/55)
...
- GetCoinTypeBalance (`sui_getBalance`) now returns a single SuiCoinBalance instead of SuiCoinBalance**s** (array of SuiCoinBalance). See above, in Added, GetAllCoinBalances support
instead of array [0.20.0](https://github.com/FrankC01/pysui/issues/55)
