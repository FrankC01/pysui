...
class SuiClient(ClientMixin):
    ...
    @deprecated(
        version="0.98.0",
        reason="JSON-RPC SuiClient (synchronous) is deprecated. Use client_factory(PysuiConfiguration()) instead. JSON-RPC support will be removed in a future release.",
    )
    def __init__(
        self,
        config: SuiConfig,
    ...
    def transaction(self, **kwargs) -> Any:
        ...
        """
        import pysui.sui.sui_txn.sync_transaction as synctxn
