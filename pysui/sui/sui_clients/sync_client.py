...
class SuiClient(_ClientMixin):
    ...
    def get_objects(self, address: SuiAddress = None) -> Union[SuiRpcResult, Exception]:
        ...
        :rtype: Union[SuiRpcResult,Exception]
        """
        return self.execute(GetObjectsOwnedByAddress(address if address else self.config.active_address))
