...
class SuiPublicKeySECP256R1(PublicKey):
...
class SuiPrivateKeySECP256R1(PrivateKey):
    ...
    def sign_secure(self, public_key: SuiPublicKeySECP256R1, tx_data: str) -> SuiSignature:
        ...
        :param public_key: Public secp256r1 key of transaction signer
        :type public_key: SuiPublicKeySECP256R1
