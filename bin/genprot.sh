...
then    
    ...
    protoc -I./suiprot/ -I./suiprot/sui/rpc/v2beta/ --python_betterproto_opt=typing.310 --python_betterproto_out=pysui/sui/sui_grpc/suimsgs ./suiprot/sui/rpc/v2beta/*.proto
