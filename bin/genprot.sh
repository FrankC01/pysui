...
then
    # protoc -I./suiprot/ -I./suiprot/sui/rpc/v2alpha/ --python_betterproto2_opt=typing.310 --python_betterproto2_opt=client_generation=async --python_betterproto2_out=pysui/sui/sui_grpc/suimsgs ./suiprot/sui/rpc/v2alpha/*.proto    
