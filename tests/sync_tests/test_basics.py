...
def test_addresses(sui_client: SyncClient) -> None:
...
def test_base_types(sui_client: SyncClient) -> None:
...
def test_gets(sui_client: SyncClient) -> None:
...
def test_txn_gets(sui_client: SyncClient) -> None:
